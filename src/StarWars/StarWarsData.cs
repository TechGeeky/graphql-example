...
namespace StarWars
{
    public class StarWarsData
    {
        ...
        public Task<Human> GetHumanByIdAsync(HorusContainerRequest human)
        {
            return Task.FromResult(_humans.FirstOrDefault(h => h.Id == human.SiteId.ToString()));
        }
        ...
        {
            Console.WriteLine("Data-2: " + human);
